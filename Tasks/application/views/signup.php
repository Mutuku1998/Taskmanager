...
<h2>Register</h2>
<p class="hint-text">Create your account. To login to continue</p>
...
<?php echo form_input(['name'=>'emailid','class'=>'form-control','value'=>set_value('emailid'),'placeholder'=>'Enter your Email id']);?>
 ...
 <div class = "form-group">
    <?php echo form_input(['name' =>'phone','class'=>'form-control','value'=>set_value('phone'),'placeholder'=>'Enter Phone Number']);?>
...
<div class="form-group">
<?php echo form_submit(['name'=>'insert','value'=>'Register','class'=>'btn btn-success btn-lg btn-block']);?>
        </div>
    </form>
    <?php echo form_close();?>
